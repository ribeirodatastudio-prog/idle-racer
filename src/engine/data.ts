...
export const BASE_SEGMENT_TIMES: Record<SegmentType, number> = {
  [SEGMENT_TYPES.LOW_SPEED_CORNER]: 6.0,
  [SEGMENT_TYPES.MEDIUM_SPEED_CORNER]: 4.5,
  [SEGMENT_TYPES.HIGH_SPEED_CORNER]: 3.0,
  [SEGMENT_TYPES.SHORT_STRAIGHT]: 2.0,
  [SEGMENT_TYPES.MEDIUM_STRAIGHT]: 5.0,
  [SEGMENT_TYPES.LONG_STRAIGHT]: 12.0,
};
